...
export default class CommentsDAO {
  ...
  */
  ...
  static async addComment(
    ...
    try {
      ...
      const commentDoc = {
        ...
        date,
        text: comment,
        movie_id: (ObjectId as any)(movieId)
      };
  ...
  static async updateComment(
    ...
    try {
      ...
      const updateResponse = await comments.updateOne(
        { _id: (ObjectId as any)(commentId), email: userEmail },
        { $set: { text, date } }
      );
  ...
  static async deleteComment(commentId: string, userEmail: string) {
    /**
