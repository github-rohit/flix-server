...
export default class MoviesDAO {
   ...
   */
  static async getMoviesByCountry(countries: string) {
    /**
    Ticket: Projection
   ...
   */
  static castSearchQuery(cast: string) {
   ...
   */
  static genreSearchQuery(genre: string) {
    /**
  ...
  static async getMovies({
    ...
    let { query = {}, project = {}, sort = DEFAULT_SORT }: any = queryParams;
    let cursor;
    try {
      cursor = await movies
        .find(query)
